...
public class LibraryMusicAdapter extends RecyclerView.Adapter<LibraryMusicViewHolders> {

    private List<LibraryMusicObject> libraryMusicList;
    private Context context;


    public LibraryMusicAdapter(List<LibraryMusicObject> libraryMusicList, Context context){
    ...
    @NonNull
    @Override
    public LibraryMusicViewHolders onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        LibraryMusicViewHolders rcv = new LibraryMusicViewHolders((layoutView));
    ...
    @Override
    public void onBindViewHolder(LibraryMusicViewHolders holder, int position) {
