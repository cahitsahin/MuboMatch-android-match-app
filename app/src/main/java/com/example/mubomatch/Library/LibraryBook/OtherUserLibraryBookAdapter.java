...
public class OtherUserLibraryBookAdapter extends RecyclerView.Adapter<OtherUserLibraryBookViewHolders> {

    private List<LibraryBookObject> libraryBookList;
    private Context context;


    public OtherUserLibraryBookAdapter(List<LibraryBookObject> libraryBookList, Context context){
    ...
    @NonNull
    @Override
    public OtherUserLibraryBookViewHolders onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        OtherUserLibraryBookViewHolders rcv = new OtherUserLibraryBookViewHolders((layoutView));
    ...
    @Override
    public void onBindViewHolder(OtherUserLibraryBookViewHolders holder, int position) {
        ...
        if (!libraryBookList.get(position).getImage().equals("NoImage")){
