...
public class OtherUserLibraryMovieAdapter extends RecyclerView.Adapter<OtherUserLibraryMovieViewHolders> {

    private List<LibraryMovieObject> libraryMoviesList;
    private Context context;


    public OtherUserLibraryMovieAdapter(List<LibraryMovieObject> libraryMoviesList, Context context){
    ...
    @NonNull
    @Override
    public OtherUserLibraryMovieViewHolders onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        OtherUserLibraryMovieViewHolders rcv = new OtherUserLibraryMovieViewHolders((layoutView));
    ...
    @Override
    public void onBindViewHolder(OtherUserLibraryMovieViewHolders holder, int position) {
